...
#import <ThirdFramework/asihttprequest/Reachability/Reachability.h>
...
@property int rewardActivityEachUserGetRedEnvelopeCount;
@property int rewardActivityUserShareRedEnvelopeCount;
