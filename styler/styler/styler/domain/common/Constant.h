...
//
#define gaode_map_key        @"609f294706e6dbe54bbb4b1eadb061cc"
...
#define page_name_organization_map           @"商户地图"
...
#define log_event_name_call_org_phone               @"拨打商户电话"
...
#define log_event_name_select_org                   @"查看商户详情"
...
#define log_event_name_view_hdc_in_organization     @"商户详情页查看美发卡"
...
#define log_event_name_index_selected_businessCircles   @"首页-选择商圈"

#define log_event_name_share_organization_reward_activity     @"分享商户得红包奖励活动"
#define log_event_name_share_hdc_reward_activity     @"分享美发卡得红包奖励活动"
#define log_event_name_share_app_reward_activity_by_index     @"主页分享app得红包奖励活动"


#define APP_ID 673935108

#define shishangmaoAppURL @"https://itunes.apple.com/cn/app/shi-shang-mao/id673935108?mt=8"
#define shishangmaoWebShortURL    @"http://wdl.so/23FjUeEZ"
