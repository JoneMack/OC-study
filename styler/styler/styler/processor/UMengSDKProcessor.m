...
- (void)onlineConfigCallBack:(NSNotification *)notification {
    ...
    param = [NSString stringWithFormat:@"rewardActivityEachUserGetRedEnvelopeCount"];
    NSString *rewardActivityEachUserGetRedEnvelopeCount = [MobClick getConfigParams:param];
    
    param = [NSString stringWithFormat:@"rewardActivityUserShareRedEnvelopeCount"];
    NSString *rewardActivityUserShareRedEnvelopeCount = [MobClick getConfigParams:param];
    ...
    if (rewardActivityEachUserGetRedEnvelopeCount && ![rewardActivityEachUserGetRedEnvelopeCount isEqualToString:@""]) {
        as.rewardActivityEachUserGetRedEnvelopeCount = [rewardActivityEachUserGetRedEnvelopeCount intValue];
    }
    if (rewardActivityUserShareRedEnvelopeCount && ![rewardActivityUserShareRedEnvelopeCount isEqualToString:@""]) {
        as.rewardActivityUserShareRedEnvelopeCount = [rewardActivityUserShareRedEnvelopeCount intValue];
    }
