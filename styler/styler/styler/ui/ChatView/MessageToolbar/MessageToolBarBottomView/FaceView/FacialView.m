...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = [ColorUtils colorWithHexString:light_gray_color];
    }
    return self;
}
...
-(void)loadFacialView:(int)page size:(CGSize)size
{
    ...
    [deleteButton setFrame:CGRectMake((maxCol - 1) * itemWidth-5, (maxRow - 1) * itemHeight, itemWidth, itemHeight)];
...
//    [sendButton setTitle:@"发送" forState:UIControlStateNormal];
    ...
    [sendButton setFrame:CGRectMake((maxCol - 2) * itemWidth - 10, (maxRow - 1) * itemHeight + 5, itemWidth , itemHeight - 10)];
