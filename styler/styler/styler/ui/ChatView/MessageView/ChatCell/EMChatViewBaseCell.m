...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    if (_messageModel.headImageName != nil) {
        [_headImageView setImage:[UIImage imageNamed:_messageModel.headImageName]];
    }else{
        UIImage *placeholderImage = [UIImage imageNamed:@"user_default_image_before_load"];
        [_headImageView setImageWithURL:_messageModel.headImageURL placeholderImage:placeholderImage];
    }
