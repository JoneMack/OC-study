...
@interface StylistProfileController : UIViewController <UITableViewDataSource, UITableViewDelegate,UIAlertViewDelegate,ISSShareViewDelegate,ISSViewDelegate>
