...
#define pickerView_row_height 33
#define left_component_width  180
...
/**
 *  通过自定义的方式来实现修改UIPickerView 的字体大小
 *
 *  @param pickerView
 *  @param row
 *  @param component
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    if (pickerView == self.servicePackagePicker) {
        customLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, screen_width, pickerView_row_height)];
        customLab.textAlignment = NSTextAlignmentCenter;
        customLab.text = ((StylistServicePackage *)[self.servicePackages objectAtIndex:row]).name;
        customLab.font = [UIFont systemFontOfSize:bigger_font_size];
        ...
        if (component == 0) {
            ...
            customLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, left_component_width, pickerView_row_height)];
            customLab.textAlignment = NSTextAlignmentCenter;
            customLab.text = dateStr;
            customLab.font = [UIFont systemFontOfSize:bigger_font_size];
            customLab.backgroundColor = [UIColor clearColor];
        }else {
            //小时选择器部分
            ...
            customLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, screen_width-left_component_width, pickerView_row_height)];
            customLab.text = hourTxt;
            customLab.textAlignment = NSTextAlignmentCenter;
            customLab.font = [UIFont systemFontOfSize:bigger_font_size];
            customLab.backgroundColor = [UIColor clearColor];
        }
