...
- (void)viewDidLoad
{
    ...
    [nc addObserver:self selector:@selector(renderUI) name:notification_name_remind_user_update_default_name object:nil];
...
-(void) initTableView
{
    ...
    defaultUserNameDotImage.frame = CGRectMake(red_dot_setting_x, (general_cell_height-red_dot_width)/2, red_dot_width, red_dot_width);
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        if ([defaultUserNameDotImage isDescendantOfView:cell.contentView]) {
            [defaultUserNameDotImage removeFromSuperview];
        }
        ...
        [cell.contentView addSubview:defaultUserNameDotImage];
