...
{
    NSDictionary * dic = [NSDictionary dictionaryWithObjectsAndKeys:[NSDictionary dictionaryWithObjectsAndKeys:[NSDictionary dictionaryWithObjectsAndKeys:@"查看",@"action-loc-key",@"时尚猫:您好，我是客服猫猫，有什么需要帮助的请随时联系我。\n",@"body", nil],@"alert",@"3",@"badge",@"bingbong.aiff",@"sound", nil],@"aps",@"3",@"nt",@"-1",@"sn", nil];
