...
-(void)renderUI:(Evaluation *)evaluation fold:(BOOL)flod
{
    ...
    #pragma mark ------ 头部部分 -------
    //设置头像
    [self.avatarImageVIew setImageWithURL:[NSURL URLWithString:evaluation.stylistEvaluation.stylist.avatarUrl]];
    ...
    //对发型师的下架状态做设置
    if (evaluation.stylistEvaluation.stylist.dataStatus == stylist_data_status_out_of_stack) {
