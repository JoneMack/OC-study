...
@interface OrganizationDetailInfoController : UIViewController<UIWebViewDelegate,UIGestureRecognizerDelegate,UIActionSheetDelegate,ISSShareViewDelegate,ISSViewDelegate , RewardActivityProcessorDelegate>
