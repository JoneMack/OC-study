...
-(void)renderOrderView:(ServiceOrder *)order
{
    ...
    //渲染发型师名字
    self.stylistName.text = order.stylist.nickName;
    CGSize size = CGSizeMake(200, 25);
    CGSize stylistNameSize = [order.stylist.nickName sizeWithFont:self.stylistName.font constrainedToSize:size lineBreakMode:NSLineBreakByWordWrapping];
