...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    if (!self.moreView) {
        ...
        self.moreView.backgroundColor = [ColorUtils colorWithHexString:light_gray_color];
        ...
        [self.moreView addSubview:upSpliteLine];
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = [ColorUtils colorWithHexString:backgroud_color];
        self.faceView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
        
        UIView *upSpliteLine = [[UIView alloc]init];
        upSpliteLine.frame = CGRectMake(0, 0, screen_width, splite_line_height);
        upSpliteLine.backgroundColor = [ColorUtils colorWithHexString:splite_line_color];
        [self.faceView addSubview:upSpliteLine];
