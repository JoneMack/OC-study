...
#define IS_IPHONE_4_OR_LESS   (screen_height < 568.0)?YES:NO
#define IS_IPHONE_5           (screen_height == 568.0)?YES:NO
#define IS_IPHONE_6           (screen_height == 667.0)?YES:NO
#define IS_IPHONE_6P          (screen_height == 736.0)?YES:NO
...
// 字体颜色
#define text_color_deep_gray      @"3d3d3d"
#define text_color_deep_gray2     @"2b2b2b"
#define text_color_deep_gray3     @"595959"
#define text_color_deep_gray4     @"b2b2b2"
#define text_color_light_gray     @"8c8c8c"

#define text_color_gray           @"737373"
#define text_color_gray2          @"73715c"
#define text_color_purple         @"9c0ca9"
#define text_color_orange         @"ff9f40"
#define text_color_orange2        @"e87d15"
#define text_color_yellow         @"f2c230"
#define text_color_blue           @"479cef"
#define text_color_red            @"fa4b86"
#define text_color_light_purple   @"f155fe"
#define text_color_green          @"26bf4c"
#define text_color_green2         @"1FCE4D"

// 线的颜色
#define separator_line_color      @"b3b3b3"


// 背景色
#define bg_deep_gray_color        @"363938"
#define bg_purple                 @"9800a5"
#define bg_gray                   @"f5f5f5"
#define bg_gray2                  @"e6e6e6"
#define bg_yellow                 @"f3bf2e"
#define bg_light_yellow           @"fffef0"
...
// 高度
#define header_view_height        95   // header高度



#define account_session_from_last_view    1    // 登录完成后返回到上一个视图
...
#define notification_name_bind_left_menu_touch_slide_event      @"bind_left_menu_touch_slide_event"
#define notification_name_unbind_left_menu_touch_slide_event    @"unbind_left_menu_touch_slide_event"
#define notification_name_rent_delegate_select_quyu         @"rent_delegate_select_quyu"
#define notification_name_rent_delegate_select_shangquan    @"rent_delegate_select_shangquan"
#define notification_name_user_poi_has_update               @"user_poi_has_update"


#define notification_name_show_left_menu                    @"showLeftMenu"
#define notification_name_show_left_menu_event              @"showLeftMenuEvent"
#define notification_name_close_left_menu_event             @"closeLeftMenuEvent"
#define notification_name_main_show_recommend_house_source  @"mainshowRecommendHouseSource"
#define notification_name_main_show_near_house_source       @"mainshowNearHouseSource"
#define notification_name_go_in_user_login_view             @"goInUserLoginView"
#define notification_name_go_in_coupon_view                 @"goInMyCouponView"
#define notification_name_go_in_my_contract_view            @"goInMyContractView"
#define notification_name_go_in_smart_lock_view             @"goInSmartLockView"
#define notification_name_go_in_message_center_view         @"goInMessageCenterView"
#define notification_name_go_in_user_setting_view           @"goInUserSettingView"
#define notification_name_go_in_user_collection_look_view           @"goInUserCollectionView"

#define push_from_fill_user_vc   @"pushfromfilluservc"
...
//分享文字
#define share_app_title              @"相寓"
#define share_app_txt                @"相寓每一天"
...
#define request_exception_api_token_expired        @"1000100030002"  // api定义的token失效编号
#define request_exception_app_token_expired        40401  // app自定义的token失效编号
