...
@implementation XBCustomSegmentView
...
//    [self addSubview:self.redLineView];
    ...
    for (int i = 0; i < btnTitleArray.count; i ++) {
        ...
        selectBtn.frame = CGRectMake(x, 0, btnWidth, 45);
...
-(void)selectIndex:(int)index{
    ...
    [previousBtn setTitleColor:[ColorUtils colorWithHexString:text_color_gray] forState:UIControlStateNormal];
