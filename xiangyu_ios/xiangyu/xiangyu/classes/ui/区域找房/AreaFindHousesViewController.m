//
//  AreaFindHousesViewController.m
//  xiangyu
//
...
@interface AreaFindHousesViewController ()
...
@implementation AreaFindHousesViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.headerView = [[HeaderView alloc] initWithTitle:@"区域找房" navigationController:self.navigationController];
