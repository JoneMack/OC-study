...
//失败的回调
@property (nonatomic, copy) void (^failureCompletionBlock)(GRBaseRequest *, NSError *error);

//成功的回调
@property (nonatomic, copy) void (^successCompletionBlock)(GRBaseRequest *, id responeObject);
