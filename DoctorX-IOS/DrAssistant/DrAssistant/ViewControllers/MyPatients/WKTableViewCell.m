...
withRightButtonTitles:(NSArray *)rightButtonTitles{
    ...
    if (self) {
        ...
        _scrollView.contentSize=CGSizeMake(kSCREEN_WIDTH+WKTableViewCellButtonWidth*(rightButtonTitles.count), self.bounds.size.height-0.5);
        ...
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(70, 59.5, kSCREEN_HEIGHT-70, 0.5)];
        self.lineView.backgroundColor = COLOR(207, 210, 213, 0.7);
        ...
        for (int a=0; a<self.rightButtonTitles.count; a++) {
            ...
            if (a == 0) {
                button.backgroundColor = COLOR(255, 0, 0, 1);
                [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            }else if (a == 1){
                [button setTitleColor:COLOR(17, 153, 203, 1) forState:UIControlStateNormal];
                button.backgroundColor = COLOR(230, 231, 232, 1);
...
//        self.mtableView.tableView.userInteractionEnabled=NO;
